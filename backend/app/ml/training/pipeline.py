...
from app.ml.data.collector import BinanceDataCollector
...
class TrainingPipeline:
    ...
    def train_price_predictor(
        ...
        model_path = self.model_dir / f"price_predictor_{symbol}_{interval}_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.pkl"
